      ...
      <div className="space-y-8 max-w-3xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="lg:hidden">
            ...
            <p className="text-lg text-[var(--muted)]">
              You can explicitly tell Chatflix to remember specific information by saying things like "Remember that my response style should be concise." You can also perform multiple operations in one request like "Remove soccer from my interest core and add piano." These updates are immediately reflected in your Memory Bank.
            </p>
          </div>
