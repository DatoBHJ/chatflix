...
import { Home, BarChart, Settings, Sparkles, FileWarning, Database, AlertTriangle } from 'lucide-react';
...
export default function AdminNavigation() {
  ...
  const navItems: NavItem[] = [
    ...
    { name: 'Error Dashboard', href: '/admin/error-dashboard', icon: AlertTriangle },
