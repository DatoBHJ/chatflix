...
export const TOOLS: ToolDefinition[] = [
  ...
  { id: 'grok_video_edit', icon: <XaiLogo size={18} />, name: 'Grok Video to Video', description: 'xAI Grok Imagine; input up to 8.7s, 480p or 720p.', category: 'ai-generation', background: 'linear-gradient(0deg, #1a1a1a 0%, #2a2a2a 100%)', placeholder: { mobile: 'Describe changes to the video', desktop: 'Describe changes to the video' }, hasInfoIcon: true },
