...
export const TOOLS: ToolDefinition[] = [
  ...
  { id: 'gemini_image_tool', icon: <SiGoogle strokeWidth={0.5} className="h-4 w-4" />, name: '🍌 Nano Banana Pro', description: '1K/2K/4K; generate or edit, up to 14 images.', category: 'ai-generation', background: 'linear-gradient(0deg, #9333EA 0%, #C084FC 100%)', placeholder: { mobile: 'Generate, edit images, or create infographics', desktop: 'Generate, edit images, or create infographics' }, smallIcon: true },
  { id: 'seedream_image_tool', icon: <SeedreamLogo size={18} />, name: 'Seedream 4.5', description: 'Uncensored; generate or edit, 1K/2K/4K, up to 10 images.', category: 'ai-generation', background: 'linear-gradient(0deg, #355691 0%, #83D0CB 100%)', placeholder: { mobile: 'Generate or edit images in 4K', desktop: 'Generate or edit images in 4K' } },
  ...
  { id: 'video_upscaler', icon: <Video strokeWidth={1.8} />, name: '4K Video Upscaler', description: 'WaveSpeed FlashVSR; upscale to 4K only (fixed output).', category: 'ai-generation', background: 'linear-gradient(0deg, #1F2937 0%, #4B5563 100%)', placeholder: { mobile: 'Upscale this video to 4K', desktop: 'Upscale this video to 4K (fixed)' } },
  ...
  { id: 'chat_history_search', icon: <MessageCircle strokeWidth={1.8} />, name: 'Message Search', description: 'Search past chat messages across all sessions', category: 'search', background: 'linear-gradient(0deg, #1FA03A 0%, #39FF5A 100%)', placeholder: { mobile: 'Find past conversations', desktop: '지난번에 내 포지션 얘기한 대화 찾아줘' }, hasInfoIcon: true },
                                    ...
                                    <div key={tool.id}>
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          {(tool.id === 'run_python_code' || tool.id === 'browser_observe' || tool.id === 'workspace' || tool.id === 'chat_history_search') && (
                                            <div 
                                      ...
                                      {/* 정보 아이콘 - 비디오 생성 도구 및 Browser Observe에 표시 */}
                                      {tool.hasInfoIcon && (
                                        <div 
                                          data-tooltip-id="tool-selector-tooltip"
