...
import { Brain } from 'react-ios-icons';
import { LayoutGrid, Clock, Lightbulb, Smile, TrendingUp, Aperture } from 'lucide-react';

// iOS-style Messages Icon
export const MessagesIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    {/* Green rounded square background - Vibrant but semi-transparent for glass effect */}
    <rect x="0" y="0" width="60" height="60" rx="14" fill="url(#messagesGradient)" fillOpacity="0.9" />
    {/* White speech bubble with gradient - Perfectly symmetrical elliptical shape, slightly lowered with more prominent tail */}
    <path
      d="M51 30A21 17 0 1 0 15 41.5L13 48L21 45.5A21 17 0 0 0 51 30Z"
      fill="url(#speechBubbleGradient)"
    />
    <defs>
      <linearGradient id="messagesGradient" x1="30" y1="60" x2="30" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#1FA03A" />
        <stop offset="1" stopColor="#39FF5A" />
      </linearGradient>
      <linearGradient id="speechBubbleGradient" x1="30" y1="13" x2="30" y2="48" gradientUnits="userSpaceOnUse">
        <stop stopColor="#FFFFFF" />
        <stop offset="1" stopColor="#A0E4B8" />
      </linearGradient>
    </defs>
  </svg>
);

// iOS-style Photos Icon
export const PhotosIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    {/* White rounded square background - Semi-transparent for glass effect */}
    <rect x="0" y="0" width="60" height="60" rx="14" fill="url(#photosBgGradient)" fillOpacity="0.9" />

    {/* 8 Colorful petals arranged in a circle */}
    ...
    <defs>
      <linearGradient id="photosBgGradient" x1="30" y1="60" x2="30" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#E8E8ED" />
        <stop offset="1" stopColor="#FFFFFF" />
      </linearGradient>
      <linearGradient id="petal1" x1="0" y1="-23" x2="0" y2="-1" gradientUnits="userSpaceOnUse">
        <stop stopColor="#FF7575" />
        <stop offset="1" stopColor="#FF9A6B" />
      </linearGradient>
      <linearGradient id="petal2" x1="0" y1="-23" x2="0" y2="-1" gradientUnits="userSpaceOnUse">
        <stop stopColor="#FF9A6B" />
        <stop offset="1" stopColor="#FFB84D" />
      </linearGradient>
      <linearGradient id="petal3" x1="0" y1="-23" x2="0" y2="-1" gradientUnits="userSpaceOnUse">
        <stop stopColor="#FFE066" />
        <stop offset="1" stopColor="#FFD54F" />
      </linearGradient>
      <linearGradient id="petal4" x1="0" y1="-23" x2="0" y2="-1" gradientUnits="userSpaceOnUse">
        <stop stopColor="#D4E157" />
        <stop offset="1" stopColor="#9CCC65" />
      </linearGradient>
      <linearGradient id="petal5" x1="0" y1="-23" x2="0" y2="-1" gradientUnits="userSpaceOnUse">
        <stop stopColor="#66BB6A" />
        <stop offset="1" stopColor="#26A69A" />
      </linearGradient>
      <linearGradient id="petal6" x1="0" y1="-23" x2="0" y2="-1" gradientUnits="userSpaceOnUse">
        <stop stopColor="#26C6DA" />
        <stop offset="1" stopColor="#42A5F5" />
      </linearGradient>
      <linearGradient id="petal7" x1="0" y1="-23" x2="0" y2="-1" gradientUnits="userSpaceOnUse">
        <stop stopColor="#42A5F5" />
        <stop offset="1" stopColor="#5C6BC0" />
      </linearGradient>
      <linearGradient id="petal8" x1="0" y1="-23" x2="0" y2="-1" gradientUnits="userSpaceOnUse">
...
export const SettingsIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    {/* Gray rounded square background - Semi-transparent for glass effect */}
    <rect x="0" y="0" width="60" height="60" rx="14" fill="url(#settingsGradient)" fillOpacity="0.9" />

    {/* Gear shape - High fidelity style from user provided SVG */}
    <g transform="scale(1.25)">
      {/* Background layer of the gear for thickness */}
      <path 
        fill="white" 
        fillOpacity="0.4"
        stroke="white"
      ...
      />
      {/* Inner circle shape from user SVG */}
      <circle cx="24" cy="24" r="3" fill="white" fillOpacity="0.8" />
    </g>

    <defs>
      <linearGradient id="settingsGradient" x1="30" y1="60" x2="30" y2="0" gradientUnits="userSpaceOnUse">
...
export type AppMeta = {
  ...
  gradient?: string;
  iconColor?: string;
  isFullAppIcon?: boolean; // Marks that the icon already includes background and styling
};

// iOS-style Launchpad Icon (Miniature version of the actual Launchpad)
export const LaunchpadIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    {/* Miniature Tab area */}
    <rect x="12" y="18" width="5" height="1.5" rx="0.75" fill="#FFFFFF" fillOpacity="0.8" />
    <rect x="20" y="18" width="7" height="1.5" rx="0.75" fill="#FFFFFF" fillOpacity="0.2" />
    
    {/* Miniature App Grid - 6 boxes with more padding */}
    <g transform="translate(12, 26)">
      {/* Row 1 */}
      <rect x="0" y="0" width="10" height="10" rx="2.5" fill="#34C759" /> {/* Messages */}
      <rect x="13" y="0" width="10" height="10" rx="2.5" fill="#FF3B30" /> {/* Photos accent */}
      <rect x="26" y="0" width="10" height="10" rx="2.5" fill="#8E8E93" /> {/* Settings */}
      
      {/* Row 2 */}
      <rect x="0" y="13" width="10" height="10" rx="2.5" fill="#FFCC00" /> {/* Memory */}
      <rect x="13" y="13" width="10" height="10" rx="2.5" fill="#5856D6" /> {/* Pensieve */}
      <rect x="26" y="13" width="10" height="10" rx="2.5" fill="#007AFF" /> {/* New App */}
    </g>
    
    {/* Glass Gloss Effect */}
    <rect width="60" height="60" rx="14" fill="url(#launchpadGloss)" fillOpacity="0.15" />
    <defs>
      <linearGradient id="launchpadGloss" x1="0" y1="0" x2="60" y2="60" gradientUnits="userSpaceOnUse">
...
// 기본 앱 우선순위 순서 (기본 상태/비가입자와 동일)
export const DEFAULT_APP_PRIORITY_ORDER: string[] = ['messages', 'photos', 'settings'];
...
export const ALL_APPS: AppMeta[] = [
  ...
  { 
    ...
    path: '/memory/memory', 
    comingSoon: true,
    gradient: 'linear-gradient(0deg, rgba(255, 159, 10, 0.75) 0%, rgba(255, 214, 10, 0.75) 100%)',
    iconColor: '#FFFFFF'
  },
  { 
    id: 'photos', 
  ...
  { 
    ...
    isCustomIcon: true, 
    comingSoon: true,
    gradient: 'linear-gradient(0deg, rgba(88, 86, 214, 0.75) 0%, rgba(191, 90, 242, 0.75) 100%)',
    iconColor: '#FFFFFF'
  },
  { 
    id: 'settings', 
