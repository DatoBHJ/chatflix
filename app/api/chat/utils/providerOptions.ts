...
export function getProviderOptions(
  ...
  // Fireworks Provider Options (Kimi K2.5, DeepSeek V3.2, GLM-5)
  // https://fireworks.ai/models/fireworks/kimi-k2p5 — use thinking: { type: 'disabled' } for non-reasoning
  if (modelConfig?.provider === 'fireworks' && (modelConfig.id.includes('kimi-k2p5') || modelConfig.id.includes('deepseek-v3p2') || modelConfig.id.includes('glm-5'))) {
